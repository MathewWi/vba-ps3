...
//VBA  - setting constants
enum
{
	SETTING_VBA_FPS				= FIRST_VBA_SETTING,
	SETTING_VBA_GBABIOS,
	SETTING_VBA_CONTROL_STYLE,
	SETTING_VBA_DEFAULT_ALL	
};
...
//SNES9x - Total amount of VBA settings
#define MAX_NO_OF_VBA_SETTINGS				SETTING_VBA_DEFAULT_ALL+1

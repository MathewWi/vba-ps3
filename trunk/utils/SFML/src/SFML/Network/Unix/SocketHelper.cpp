...
Socket::Status SocketHelper::GetErrorStatus()
{
    ...
    switch (errno)
    {
        case SYS_NET_EWOULDBLOCK :  return Socket::NotReady;
        case SYS_NET_ECONNABORTED : return Socket::Disconnected;
        case SYS_NET_ECONNRESET :   return Socket::Disconnected;
        case SYS_NET_ETIMEDOUT :    return Socket::Disconnected;
        case SYS_NET_ENETRESET :    return Socket::Disconnected;
